...
<body>
    ...
    <div class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php"><b>DBMS project</b></a>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        ...
                        <p>Welcome to the Electricity Bill Management System portal! Our website will serve as a consumer-oriented service, providing users with a convenient platform for easy payment of their respective electricity bills. Additionally, it will facilitate interaction with service providers, allowing users to address queries or grievances efficiently.</p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1>Sign Up</h1>
    ...
    <div class="container">
        ...
        <div class="row mt centered">
            <div class="col-lg-4">
                <img src="assets/img/login.png" width="180" alt="">
                <h4>1 - Login</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->
            ...
            <div class="col-lg-4">
                ...
                <h4>2 - Check the due bills</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->

            <div class="col-lg-4">
                <img src="assets/img/transact.png" width="180" alt="">
                <h4>3 - Do the Transactions</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->
